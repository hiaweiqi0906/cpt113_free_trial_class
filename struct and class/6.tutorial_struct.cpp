...
int main(){
    /*
    Q1. Write a structure to store the name, account number and balance of customers (more than 10) and store 
    their information.
        1 - Write a function to print the names of all the customers having balance less than $200.
        2 - Write a function to add $100 in the balance of all the customers having more than $1000 in their 
            balance and then print the incremented value of their balance.
    */

   /*
    Q2. Write a program to compare two dates entered by user. Make a structure named Date to store the 
   ...
   (more than 10). Store the information of the students.
        ...
        3 - Write another function to display the details of the student whose matric no is given 
        (i.e. matric no. entered by the user).
   */
    return 0;
}